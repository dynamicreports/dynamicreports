...
public class AdhocConfigurationTest extends AdhocTests {
    ...
    public void testMarshallerException() throws Exception {
        ...
        adhocManager.saveConfiguration(adhocConfiguration1, os);
    ...
    public void testEqualsAndClone() {
        ...
        Assert.assertEquals("equals", adhocConfiguration, adhocConfiguration);
        Assert.assertEquals("equals", adhocConfiguration, adhocConfiguration2);
        AdhocColumn adhocColumn = new AdhocColumn();
        adhocColumn.setName("field3");
