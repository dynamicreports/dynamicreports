 ...
 * data from an xml. This is the type that the JAXBElement for marshalling, must therefore adhere to, and that can only be created
 * using the {@link #transform(AdhocConfiguration)} method of this class
 *
