        ...
        rb.setWhenNoDataType(WhenNoDataType.ALL_SECTIONS_NO_DETAIL)
          ...
          .title(cmp.horizontalList()
                    ...
                    .add(cmp.verticalList()
                            .setStyle(style)
                            .add(cmp.vListCell(cmp.text("")
                                                  .setWidth(50))
                                    .heightFixed())
                            .add(10, cmp.vListCell(cmp.text("")
                                                      .setWidth(50))
                    ...
                    .add(cmp.hListCell(cmp.verticalList()
                                          ...
                                          .add(cmp.vListCell(cmp.text("")
                                                  ...
                                                  .widthFixedOnCenter()
                                                  .heightFixed())
                                          .add(cmp.text(""), cmp.horizontalList()
                                                                .setStyle(style)
                                                                .add(cmp.text(""), cmp.text(""))
                                                                .add(5, cmp.text("")
                                                                           .setWidth(50)), cmp.text(""))
                                          .add(cmp.vListCell(cmp.horizontalList(cmp.text(""), cmp.text(""))
                                                                .setStyle(style))
                                                  .widthFixedOnCenter()
                                                  .heightFixed()))
                            .widthFixed()
                    ...
                    .add(cmp.verticalList()
                            ...
                            .add(cmp.vListCell(cmp.text("")
                                                  .setHeight(30)
                                                  .setWidth(50)), cmp.vListCell(cmp.text("")
                                                                                   .setWidth(50))
                                                                     .heightFixed(), cmp.vListCell(cmp.text("")
                                                                                                      .setWidth(50))
                                                                                        .widthFixedOnLeft()
                                                                                        .heightFixed(), cmp.vListCell(cmp.text("")
                                                                                                           ...
                                                                                                           .widthFixedOnLeft(), cmp.vListCell(cmp.text("")
                                                                                                                                   ...
                                                                                                                                   .heightFixed(), cmp.vListCell(cmp.text("")
                                                                                                                                                                    .setWidth(50))
                                                                                                                                                      .widthFixedOnCenter(), cmp.vListCell(cmp.text("")
                                                                                                                                                                                              .setWidth(
                                                                                                                                                                                                  50))
                                                                                                                                                                                .widthFixedOnRight()
                                                                                                                                                                                .heightFixed(),
                    ...
                    .add(cmp.hListCell(cmp.text("")
                                          .setWidth(50))
                            .heightFixedOnTop())
                    .add(cmp.hListCell(cmp.verticalList(cmp.text("")
                                                           .setWidth(50), cmp.text("")
                                                                             .setWidth(50))
                                          .setStyle(style))
                            .widthFixed()
                    ...
                    .setGap(5)
                    .setStyle(style)
                    .add(cmp.text(""), cmp.text(""), cmp.text(""), cmp.text(""), cmp.text(""), cmp.text("")
                                                                                                  .setWidth(500), cmp.text(""), cmp.text(""))
                    .newRow()
