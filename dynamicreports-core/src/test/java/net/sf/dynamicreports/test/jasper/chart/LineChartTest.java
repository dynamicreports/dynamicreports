...
public class LineChartTest extends AbstractJasperChartTest implements Serializable {
  ...
  public void test() {
    ...
    Assertions.assertFalse("show shapes", ((LineAndShapeRenderer) renderer).getDefaultShapesVisible());
    Assertions.assertFalse("show lines", ((LineAndShapeRenderer) renderer).getDefaultLinesVisible());
