...
public class XyBarChartTest extends AbstractJasperChartTest implements Serializable {
        ...
        rb.setLocale(Locale.ENGLISH)
          ...
          .summary(cht.xyBarChart()
                      ...
                      .setShowLabels(true)
						...
						.setShowTickMarks(false)*/, cht.xyBarChart()
                                                       .setXValue(column1)
                                                       .series(cht.xySerie(column2))
                                                       .setXAxisFormat(cht.axisFormat()
                                                                          ...
                                                                          .setLineColor(Color.LIGHT_GRAY)), cht.xyBarChart()
                                                                                                               .setXValue(column1)
                                                                                                               .series(cht.xySerie(column2))
    ...
    public void test() {
        ...
        Assert.assertEquals("renderer", XYBarRenderer.class, plot.getRenderer()
                                                                 .getClass());
        Assert.assertTrue("show labels", plot.getRenderer()
