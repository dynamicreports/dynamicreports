...
public class Bar3DChartTest extends AbstractJasperChartTest implements Serializable {
    ...
    protected void configureReport(JasperReportBuilder rb) {
        ...
        rb.setLocale(Locale.ENGLISH)
          ...
          .summary(cht.bar3DChart().setCategory(column1).series(cht.serie(column2)).setShowLabels(true).setXOffset(2d).setYOffset(3d), cht.bar3DChart()
                                                                                                                                          .setCategory(column1)
