...
public class GroupedStackedBarChartTest extends AbstractJasperChartTest implements Serializable {
  ...
  public void test() {
    ...
    Assertions.assertEquals("renderer", GroupedStackedBarRenderer.class,
        categoryPlot.getRenderer().getClass());
    Assertions.assertTrue("show labels", categoryPlot.getRenderer().getDefaultItemLabelsVisible());
    Assertions.assertFalse("show tick labels", categoryPlot.getDomainAxis().isTickLabelsVisible());
    Assertions.assertFalse("show tick marks", categoryPlot.getDomainAxis().isTickMarksVisible());
