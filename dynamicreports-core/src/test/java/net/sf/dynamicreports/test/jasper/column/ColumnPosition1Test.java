...
public class ColumnPosition1Test extends AbstractJasperPositionTest {
  ...
  protected void configureReport(JasperReportBuilder rb) {
    rb.addField("field1", type.integerType())
      .columns(column2 = col.column("Very long Column2 title", "field2", String.class).setFixedWidth(70),
  ...
  public void test() {
    ...
    numberOfPagesTest(1);
    elementPositionTest("columnHeader.list1", 0, 10, 10, 575, 27);
    elementPositionTest("detail.list1", 0, 10, 37, 575, 16);
    elementPositionTest("detail.list1", 1, 10, 53, 575, 27);

    // column2
    columnTitlePositionTest(column2, 0, 0, 0, 70, 27);
    columnDetailPositionTest(column2, 0, 0, 0, 70, 16);
    columnDetailPositionTest(column2, 1, 0, 0, 70, 27);
    // column3
    columnTitlePositionTest(column3, 0, 70, 0, 168, 27);
    columnDetailPositionTest(column3, 0, 70, 0, 168, 16);
    columnDetailPositionTest(column3, 1, 70, 0, 168, 27);
    // column4
    columnTitlePositionTest(column4, 0, 238, 0, 168, 27);
    columnDetailPositionTest(column4, 0, 238, 0, 168, 16);
    columnDetailPositionTest(column4, 1, 238, 0, 168, 27);
    // column5
    columnTitlePositionTest(column5, 0, 406, 0, 169, 27);
    columnDetailPositionTest(column5, 0, 406, 0, 169, 16);
    columnDetailPositionTest(column5, 1, 406, 0, 169, 27);
  }
