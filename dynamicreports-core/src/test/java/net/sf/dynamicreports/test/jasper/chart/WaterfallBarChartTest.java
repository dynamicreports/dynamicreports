...
public class WaterfallBarChartTest extends AbstractJasperChartTest implements Serializable {
    ...
    protected void configureReport(JasperReportBuilder rb) {
        ...
        rb.setLocale(Locale.ENGLISH)
          ...
          .summary(cht.waterfallBarChart()
                      ...
                      .setShowTickMarks(false), cht.waterfallBarChart()
                                                   .setCategory(column1)
                                                   .series(cht.serie(column2))
                                                   .setCategoryAxisFormat(cht.axisFormat()
                                                                             ...
                                                                             .setLineColor(Color.LIGHT_GRAY)), cht.waterfallBarChart()
                                                                                                                  .setCategory(column1)
                                                                                                                  .series(cht.serie(column2))
    ...
    public void test() {
        ...
        Assert.assertEquals("renderer", WaterfallBarRenderer.class, categoryPlot.getRenderer()
                                                                                .getClass());
