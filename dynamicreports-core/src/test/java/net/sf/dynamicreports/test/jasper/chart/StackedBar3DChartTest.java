...
public class StackedBar3DChartTest extends AbstractJasperChartTest implements Serializable {
    ...
    protected void configureReport(JasperReportBuilder rb) {
        ...
        rb.setLocale(Locale.ENGLISH)
          ...
          .summary(cht.stackedBar3DChart()
                      ...
                      .setShowLabels(true)
                      .setXOffset(2d)
                      .setYOffset(3d), cht.stackedBar3DChart()
                                          .setCategory(column1)
                                          .series(cht.serie(column2))
                                          .setCategoryAxisFormat(cht.axisFormat()
                                                                    ...
                                                                    .setLineColor(Color.LIGHT_GRAY)), cht.stackedBar3DChart()
                                                                                                         .setCategory(column1)
                                                                                                         .series(cht.serie(column2))
    ...
    public void test() {
        ...
        Assert.assertEquals("renderer", StackedBarRenderer3D.class, categoryPlot.getRenderer()
                                                                                .getClass());
