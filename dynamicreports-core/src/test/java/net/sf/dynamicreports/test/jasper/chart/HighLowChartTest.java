...
public class HighLowChartTest extends AbstractJasperChartTest {
  ...
  public void test() {
    ...
    Assertions.assertEquals("renderer", HighLowRenderer.class, renderer.getClass());
    Assertions.assertEquals("show open ticks", true, ((HighLowRenderer) renderer).getDrawOpenTicks());
    Assertions.assertEquals("show close ticks", true, ((HighLowRenderer) renderer).getDrawCloseTicks());
