...
public class LayeredBarChartTest extends AbstractJasperChartTest implements Serializable {
    ...
    protected void configureReport(JasperReportBuilder rb) {
        ...
        rb.setLocale(Locale.ENGLISH)
          ...
          .summary(cht.layeredBarChart().customizers(new ChartCustomizer()).setCategory(column1).series(cht.serie(column2)).setShowLabels(true).setShowTickLabels(false).setShowTickMarks(false),
                   cht.layeredBarChart()
                      .setCategory(column1)
                      ...
                      .setCategoryAxisFormat(cht.axisFormat()
                                                ...
                                                .setLineColor(Color.LIGHT_GRAY)), cht.layeredBarChart()
                                                                                     .setCategory(column1)
                                                                                     .series(cht.serie(column2))
